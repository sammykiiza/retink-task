...
function BlogArticleItem(props: { image: any, title: string, content: string }) {
    return (
        <div className='w-56 h-48'>
            <a href="!#">
                <img src={props.image} className="w-48 hover:w-52 ease-linear transition-all duration-150" alt="" />
                <h1 className='text-[#393939] hover:text-black ease-linear transition-all duration-150'>{props.title}</h1>
